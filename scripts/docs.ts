...
- Local package version: ${(await json(path.join(ROOT,'packages/core/package.json'))).version}. No npm registry release. Historical experimental releases do not contain later local candidates.
